...
describe('radix', () => {
  it('add', () => {
    ...
    const node = radix.add('/hello/:name/world', 'GET', handlerEnt);
  ...
  it('find', () => {
    ...
    const worldNode = radix.add('/hello/:name/world', 'GET', handlerEnt);
    ...
    const cityNode = radix.add('/hello2/:name/:city', 'GET', handlerEnt);
    ...
    expect(findResult3).toBe(undefined as any);
  });
  it('find wild', () => {
    const radix = new Radix();
    ...
    expect(resultNull).toBe(undefined as any);
  });
  it('find named and regular', () => {
    const radix = new Radix();

    radix.add('/hello/world/:name', 'GET', handlerEnt);
    radix.add('/hello/world/aleksey', 'GET', handlerEnt);
